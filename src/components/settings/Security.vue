    ...
    <div>
        ...
        <Confirm ref="confirmDisableAuth" btn-style="btn-danger" :yes-text="$t('I understand, please disable')" :no-text="$t('Leave')" @yes="disableAuth">
            <template v-if="$i18n.locale === 'es-ES' ">
                ...
                <p>Es para <strong>quien implementa autenticación de terceros</strong> ante Uptime ping como por ejemplo Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'pt-BR' ">
                ...
                <p>Isso é para <strong>alguém que tem autenticação de terceiros</strong> na frente do 'UpTime ping' como o Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'de-DE' ">
                ...
                <p>Es ist für <strong>jemanden der eine externe Authentifizierung</strong> vor Uptime ping geschaltet hat, wie z.B. Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'sl-SI' ">
                ...
                <p>Namenjen je <strong>nekomu, ki ima pred programom Uptime ping vklopljeno zunanje preverjanje pristnosti</strong>, na primer Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'sr' ">
                ...
                <p>То је за <strong>оне који имају додату аутентификацију</strong> испред Uptime ping као на пример Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'sr-latn' ">
                ...
                <p>To je za <strong>one koji imaju dodatu autentifikaciju</strong> ispred Uptime ping kao na primer Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'tr-TR' ">
                ...
                <p>Bu, Uptime ping'nın önünde Cloudflare Access gibi <strong>üçüncü taraf yetkilendirmesi olan</strong> kişiler içindir.</p>
                <p>Lütfen dikkatli kullanın.</p>
            </template>

            <template v-else-if="$i18n.locale === 'ko-KR' ">
                <p>정말로 <strong>인증 기능을 끌까요</strong>?</p>
                <p>이 기능은 <strong>Cloudflare Access와 같은 서드파티 인증</strong>을 Uptime ping 앞에 둔 사용자를 위한 기능이에요.</p>
                <p>신중하게 사용하세요.</p>
            </template>

            <template v-else-if="$i18n.locale === 'pl' ">
                <p>Czy na pewno chcesz <strong>wyłączyć autoryzację</strong>?</p>
                <p>Jest przeznaczony dla <strong>kogoś, kto ma autoryzację zewnętrzną</strong> przed Uptime ping, taką jak Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'it-IT' ">
                ...
                <p>È per <strong>chi ha l'autenticazione gestita da terze parti</strong> messa davanti ad Uptime ping, ad esempio Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'id-ID' ">
                ...
                <p>Ini untuk <strong>mereka yang memiliki autentikasi pihak ketiga</strong> diletakkan di depan Uptime ping, misalnya akses Cloudflare.</p>
            ...
            <template v-else-if="$i18n.locale === 'ru-RU' ">
                ...
                <p>Это подходит для <strong>тех, у кого стоит другая авторизация</strong> перед открытием Uptime ping, например Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'bg-BG' ">
                ...
                <p>Използва се в случаите, когато <strong>има настроен алтернативен метод за удостоверяване</strong> преди Uptime ping, например Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'hu' ">
                ...
                <p>Akkor érdemes, ha <strong>van 3rd-party hitelesítés</strong> az Uptime ping-t megelőzően mint a Cloudflare Access.</p>
            ...
            <template v-else-if="$i18n.locale === 'nb-NO' ">
                ...
                <p>Dette er for <strong>de som har tredjepartsautorisering</strong> foran Uptime ping, for eksempel Cloudflare Access.</p>
            ...
            <template v-else>
                ...
                <p>It is for <strong>someone who have 3rd-party auth</strong> in front of Uptime ping such as Cloudflare Access.</p>
