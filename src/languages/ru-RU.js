export default {
    ...
    "Uptime ping URL": "Uptime ping URL",
    ...
    aboutpingURL: "Если поле Uptime ping URL в настройках останется пустым, по умолчанию будет использоваться ссылка на проект на GitHub.",
